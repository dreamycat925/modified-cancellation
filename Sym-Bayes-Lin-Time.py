...
X = df_hs[['検査時の年齢', '性別', '教育歴',
           'my_cancellation_技術記号_所要時間',
           'my_cancellation_技術記号_正答数']].copy()
...
with pm.Model() as attention_model:
    ...
    y_obs = pm.Normal("y_obs", mu=mu, sigma=sigma, observed=X["my_cancellation_技術記号_所要時間"])
